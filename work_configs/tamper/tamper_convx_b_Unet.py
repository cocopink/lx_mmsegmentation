...
model = dict(
    type='EncoderDecoder',
    #pretrained="/home/lmf/mmsegmentation/work_dirs/tamper/convx_l_6x_dice_aug1_dec/epoch_70.pth",
    backbone=dict(
        type='ConvNeXt',
        in_chans=3,
        depths=[3, 3, 27, 3], 
    ...
    decode_head=dict(
        ...
        align_corners=False,
        # loss_decode=[
        #     dict(type='CrossEntropyLoss', use_sigmoid=True, loss_weight=0.75),
...
log_level = 'INFO'
load_from ="/home/lmf/mmsegmentation/work_dirs/tamper/convx_l_6x_dice_aug1_dec/epoch_70.pth"
resume_from = None
workflow = [('train', 1), ('val', 6)]
