...
config_file = '/home/lmf/mmsegmentation/work_configs/tamper/tamper_swin_b_team_ft2.py'
checkpoint_file = '/home/lmf/mmsegmentation/work_dirs/tamper/swin_b_team_ft2_12k/epoch_105.pth'
model = load_model(config_file, checkpoint_file)
model.eval()

# 设置输入和输出文件夹
input_folder = '/home/lmf/mmsegmentation/data/tamper/train2/img'
output_folder = '/home/lmf/mmsegmentation/val_paddle_swin'
...
for image_file in image_files:
    ...
    # 获取图像的文件名
    basename = os.path.basename('/home/lmf/0628.jpg')#image_file
    # 为输出文件构建路径
